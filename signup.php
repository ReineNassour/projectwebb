...
<body>
   ...
   <div class="login-box">
        ...
        <div class="input-box">
            <input type="text" name="fn" class="input-field" placeholder="First Name" autocomplete="off">
        </div>
        <?php
        if(isset($_SESSION['signupErr']['fn'])){
            echo '<p class="red">'.$_SESSION['signupErr']['fn'].'</p>';
            unset($_SESSION['signupErr']['fn']);
        }
        ?>
        <div class="input-box">
            <input type="text" name="ln" class="input-field" placeholder="Last Name" autocomplete="off">
        </div>
        <?php
        ...
        <div class="sign-up-link">
            <p class="text-white">Already Registered? <a href="login.php" class="text-secondary">Login</a></p>
        </div>
    </div>
   </form>
</body>
